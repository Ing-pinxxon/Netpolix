...
class Series(Base):
    ...
    # En MySQL la columna sigue llamándose sipnosis; en Python usamos sinopsis (API y DAO).
    sinopsis = Column(String(255), name="sipnosis", nullable=False)
